...
export default function BoxModel1(props) {
  return (
    <>
      <div className="not-for-small">
        <div className="row" style={{ width: "100%" }}>
          ...
          <div
            className="col-lg-4 fadeInUp animated delay-0 wpb_start_animation wpb_animate_when_almost_visible wpb_start_animation"
